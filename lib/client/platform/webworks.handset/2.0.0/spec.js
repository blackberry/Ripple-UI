...
module.exports = {
    ...
    ui: ripple('platform/webworks.handset/2.0.0/spec/ui'),
    device: ripple('platform/webworks.handset/2.0.0/spec/device'),
    config: ripple('platform/webworks.core/2.0.0/spec/config'),
    events: ripple('platform/webworks.handset/2.0.0/spec/events'),
