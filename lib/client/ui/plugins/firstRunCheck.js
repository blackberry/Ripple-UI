...
function _addPlatformButton(platform, version) {
    var section = jQuery(".platform-select-buttons"),
        buttonID = "platform-" + platform.id + "-" + version,
    ...
    button.appendChild(utils.createElement("span", {
        ...
        "innertext" : platform.name + " (" + version + ")"
    }));
...
function _initializeFirstRunCheck() {
    ...
    if (!savedPlatform) {
        ...
        p = (width / 2) - 277;
/*
 * default platform is Obigo Moile.
 ...
 */
        _handleFirstRunResponse(ripple('platform/Obigo-Mobile/default/spec'), "default");
    }
}
