...
//Changed for because this function did not take outer scrolling into the equation and is not as performance focused
...
function menuTouchMoveHandler(evt) {
    ...
    //Code changed for , no longer using complicated math
