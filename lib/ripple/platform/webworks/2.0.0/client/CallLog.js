...
CallLog.__defineGetter__("STATUS_NUMBER_UNOBTAINABLE", _get(3));
CallLog.__defineGetter__("STATUS_PATH_UNAVAILABLE", _get(4));
...
CallLog.__defineGetter__("STATUS_INCOMING_CALL_BARRED", _get(27));
