 ...
 */
var Acceleration = require('ripple/platform/phonegap/0.9/Acceleration'),
...
event.on("AccelerometerInfoChangedEvent", function (accelerometerInfo) {
    _accelerometerInfo.x = accelerometerInfo.x / 9.8;
    _accelerometerInfo.y = accelerometerInfo.y / 9.8;
    _accelerometerInfo.z = accelerometerInfo.z / 9.8;
