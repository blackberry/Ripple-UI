...
var _orig = window.webkitResolveLocalFileSystemURL,
    coreFS = require('ripple/platform/webworks.bb10/1.0.0/coreFileSystem');

module.exports = function (url, success, fail) {
    var sandboxed = require('ripple/platform/webworks.bb10/1.0.0/io').sandbox;
    ...
    function internalSuccess(entry) {
        ...
        if (entry.isDirectory) {
            myEntry = coreFS.createDirctoryEntry(entry, entry.fileSystem, sandboxed);
        }
        else {
