...
module.exports = {
    ...
    extractInfo: function (config) {
        ...
        widgetInfo.permission = config.rawJSON.widget[0]["rim:invoke-target"];
        widgetInfo.accessShared = config.rawJSON.widget[0]["rim:permissions"];
        ...
        console.log("permissions", widgetInfo.permissions);
