...
function generateMenuItems(menuItems) {
    ...
    for (i = 0; i < menuItems.length; i++) {
        ...
        case 'Delete':
            break;
        case 'Cancel':
            items.push({'label': 'Dismiss Selection', 'actionId': 'Cancel', 'imageUrl': extensionUrl + 'images/Browser_Cancel_Selection.png', 'isDelete': true});
            hasCancel = true;
            break;
        case 'Cut':
        ...
        case 'OpenLinkInNewTab':
            break;
        case 'OpenLink':
            items.push({'label': 'Open', 'actionId': 'OpenLink', 'imageUrl': extensionUrl + 'images/Browser_OpenLink.png'});
            break;
        case 'SaveLinkAs':
            items.push({'label': 'Save Link as', 'actionId': 'SaveLinkAs', 'imageUrl': extensionUrl + 'images/Browser_SaveLink.png'});
            break;
        case 'SaveImage':
            items.push({'label': 'Save Image', 'actionId': 'SaveImage', 'imageUrl': extensionUrl + 'images/Browser_SaveImage.png'});
            break;
        case 'CopyImageLink':
        ...
        case 'ShareLink':
            ...
            if (!/^local|^file/.test(_currentContext.url)) {
                items.push({'label': 'Share Link', 'actionId': 'ShareLink', 'imageUrl': extensionUrl + 'images/Browser_ShareLink.png'});
            }
            break;
        case 'ShareImage':
            break;
        case 'InspectElement':
            items.push({'label': 'Inspect Element', 'actionId': 'InspectElement', 'imageUrl': extensionUrl + 'images/generic_81_81_placeholder.png'});
            break;
        }
    }

    if (!hasCancel) {
        items.push({'label': 'Cancel', 'actionId': 'Cancel', 'imageUrl': extensionUrl + 'images/Browser_Cancel_Selection.png', 'isDelete': true});
    }
