...
module.exports = {
    exec: function (success, fail, service, action, args) {
        var emulator = {
            ...
            "Camera": require('ripple/platform/cordova/1.6/bridge/camera'),
            "Capture": require('ripple/platform/cordova/1.6/bridge/capture'),
            "Contacts": require('ripple/platform/cordova/1.6/bridge/contacts'),
            "Debug Console": require('ripple/platform/cordova/1.6/bridge/console'),
            "Device": require('ripple/platform/cordova/1.6/bridge/device'),
            "File": require('ripple/platform/cordova/1.6/bridge/file'),
            "Geolocation": require('ripple/platform/cordova/1.6/bridge/geolocation'),
            "Media": require('ripple/platform/cordova/1.6/bridge/media'),
