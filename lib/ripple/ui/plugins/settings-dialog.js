...
var db = require('ripple/db'),
    ...
    required = {
        ...
        launch: {
            ...
            "webworks.bb10": ["sdk", "projectPath", "outputPath", "projectName", "device", "devicePassword"],
    ...
    perform: function (action) {
        var settings = _settings.get(),
            ...
            poll = function (resp) {
                ...
                if (resp && resp.code !== 0) {
                    notifications.openNotification("error", "1 Build request failed with message: " + resp.msg);
                    _endProgress();
                }
                else {
                        ...
                        setTimeout(function () {
                            bus.ajax(
                                ...
                                function (errorText) {
                                    ...
                                    notifications.openNotification("error", "2 Build request failed with message: " + errorText);
                                    _endProgress();
                                }
                            );
                        }, 500);
        ...
        bus.ajax(
            ...
            function (error) {
                console.log(error);
                notifications.openNotification("error", "0 Build request failed with message: " + JSON.stringify(error));
            }
        );
    }
};
