...
module.exports = {
    ...
    initialize: function () {
        var GEO_OPTIONS = constants.GEO.OPTIONS,
            ...
            gpxFile = document.getElementById(GEO_OPTIONS.GPXFILE),
            ...
            reader.onload = function (e) {
                ...
                for (i = 0; i < t.length; i++) {
                    ...
                    track.push({
                        ...
                        timestamp: new Date($(t[i]).find("time")[0].innerText).getTime()
                    });
                }
            };
        ...
        function moveNextGpxTrack(i)
        {
            ...
            console.log((_interval / 1000) + "s (" + _interval / 1000 * _timeMultiplier + "s realtime), " + (i + 1) + " of " + track.length + " (stepping " + _step + " at " + _timeMultiplier + "x)");
            ...
            setTimeout(function () {
                ...
                if (track[i + _step]) {
                    ...
                    if (i < track.length - 1) {
                        ...
                        console.log("Ripple :: Finished replaying GPX file (We have arrived, assuming standard orbit.)");
                    }
                }
            }, _interval);
        }
