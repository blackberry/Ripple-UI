...
var utils = require('ripple/utils'),
    ...
    _self, _fs, _resolveLocalFileSystemURL;
...
_self = {
    initialize: function (prev, baton) {
        try {
            ...
            _resolveLocalFileSystemURL = window.resolveLocalFileSystemURL || window.webkitResolveLocalFileSystemURL;
    ...
    read: function (path, success, error, opts) {
        if (!opts) { opts = {}; }
