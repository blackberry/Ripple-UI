...
module.exports = {
    start: function (options) {
        ...
        // TODO does not work with custom route (since does not dynamicaly know custom ones, yet, if set)
...
// TODO: This should just talk about how to enable via query params
//        app.use(options.route + "/enable/", express.static(__dirname + "/../../assets/server"));
//
//        console.log();
//        console.log("INFO:".green + " Load the URL below (in Chrome) to auto-enable .");
