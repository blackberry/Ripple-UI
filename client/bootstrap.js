...
function _bindObjects(win, doc) {
    if (!win.tinyHippos) {
        require('ripple/client/emulatorBridge').init(win, doc);
        require('ripple/client/touchEventEmulator').init(win, doc);
        require('ripple/client/deviceMotionEmulator').init(win, doc);
        require('ripple/client/resizer').init(win, doc);
        require('ripple/client/cssMediaQueryEmulator').init(win, doc);
        _bound = true;
    }
}
...
function _cleanBody() {
    require('ripple/client/utils').forEach(document.body.children, function (child) {
...
function _bootstrap() {
    ...
    window.tinyHippos = require('ripple/client/index');
