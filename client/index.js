...
var omgwtf = require('ripple/client/omgwtf'),
    ...
    widgetConfig = require('ripple/client/widgetConfig'),
    deviceSettings = require('ripple/client/deviceSettings'),
    ui = require('ripple/client/ui'),
    appcache = require('ripple/client/appcache'),
    _self = {
        boot: function (booted) {
            ...
            // TODO: this should be somewhere else (such as ripple/client/bootstrap).
