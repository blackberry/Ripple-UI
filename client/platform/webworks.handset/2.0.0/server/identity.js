...
var _self,
    ...
    Transport = require('ripple/client/platform/webworks.handset/2.0.0/client/identity/Transport'),
...
_self = {
    getDefaultService: function () {
        var services = _services.filter(function (service) {
            return service.isDefault === true;
        });
        return {code: 1, data: services};
    },
