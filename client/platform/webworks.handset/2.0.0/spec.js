...
module.exports = {
    ...
    ui: require('ripple/client/platform/webworks.handset/2.0.0/spec/ui'),
    device: require('ripple/client/platform/webworks.handset/2.0.0/spec/device'),
    config: require('ripple/client/platform/webworks.core/2.0.0/spec/config'),
    events: require('ripple/client/platform/webworks.handset/2.0.0/spec/events'),

    initialize: function () {
        // techdebt (event registration timing)
        require('ripple/client/platform/webworks.core/2.0.0/fsCache');
        require('ripple/client/platform/webworks.core/2.0.0/fs').initialize();
    },
