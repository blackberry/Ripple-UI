...
var _orig = window.webkitRequestFileSystem,
    ...
    _io = require('ripple/client/platform/webworks.bb10/1.0.0/io'),
    _appId = require('ripple/client/app').getInfo().id,
...
module.exports = function (type, size, success, fail) {
    var _internalFS = {},
        ...
        coreFS = require('ripple/client/platform/webworks.bb10/1.0.0/coreFileSystem');
