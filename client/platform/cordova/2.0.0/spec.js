function loadWebworks(win, device) {
    ...
    webworks = require('ripple/client/platform/webworks.' + platform + '/spec');
...
module.exports = {
    ...
    config: require('ripple/client/platform/cordova/2.0.0/spec/config'),
    device: require('ripple/client/platform/cordova/2.0.0/spec/device'),
    ui: require('ripple/client/platform/cordova/2.0.0/spec/ui'),
    events: require('ripple/client/platform/cordova/2.0.0/spec/events'),

    initialize: function (win) {
        var honeypot = require('ripple/client/honeypot'),
            devices = require('ripple/client/devices'),
            device = devices.getCurrentDevice(),
            bridge = require('ripple/client/platform/cordova/2.0.0/bridge'),
            cordova,
            topCordova = window.top.require('ripple/client/platform/cordova/2.0.0/spec'),
            get = function () {
                return cordova;
            },
            set = function (orig) {
