module.exports = {
    ...
    config: require('ripple/client/platform/cordova/1.0.0/spec/config'),
    device: require('ripple/client/platform/cordova/1.0.0/spec/device'),
    ui: require('ripple/client/platform/cordova/1.0.0/spec/ui'),
    events: require('ripple/client/platform/cordova/1.0.0/spec/events'),
