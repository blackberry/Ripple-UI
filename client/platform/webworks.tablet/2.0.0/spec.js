...
module.exports = {
    ...
    ui: require('ripple/client/platform/webworks.tablet/2.0.0/spec/ui'),
    device: require('ripple/client/platform/webworks.tablet/2.0.0/spec/device'),
    config: require('ripple/client/platform/webworks.core/2.0.0/spec/config'),
    events: require('ripple/client/platform/webworks.tablet/2.0.0/spec/events'),
