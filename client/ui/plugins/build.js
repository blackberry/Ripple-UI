...
var tooltip = require('ripple/client/ui/plugins/tooltip'),
    settings = require('ripple/client/ui/plugins/settings-dialog'),
...
function areServicesRunning(success, fail) {
    bus.ajax(
        "GET",
        "http://127.0.0.1:9910/ripple/client/about",
        null,
        function () {
            success();
        },
