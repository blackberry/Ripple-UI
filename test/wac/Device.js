...
describe("wac_Device", function () {
    ...
    it("getAvailableApplications should return a valid non empty array", function () {
        var arr = Device.getAvailableApplications();
    ...
    it("vibrate should call successfully", function () {
        expect(function () {
            Device.vibrate(50);
        }).not.toThrow();
    });
