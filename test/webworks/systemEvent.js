...
describe("webworks system event", function () {
    var sysEvent = require('ripple/platform/webworks.core/2.0.0/server/systemEvent'),
        client = require('ripple/platform/webworks.core/2.0.0/client/systemEvent'),
        transport = require('ripple/platform/webworks.core/2.0.0/client/transport'),
        menu = require("ripple/platform/webworks.core/2.0.0/server/menu"),
