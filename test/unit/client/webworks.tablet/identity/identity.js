...
describe("webworks identity", function () {
    var identity = require('ripple/client/platform/webworks.tablet/2.0.0/server/identity'),
        ...
        identityClient = require('ripple/client/platform/webworks.tablet/2.0.0/client/identity'),
        deviceSettings = require('ripple/client/deviceSettings'),
        spec = require('ripple/client/platform/webworks.tablet/2.0.0/spec'),
        webworks = require('ripple/client/platform/webworks.tablet/2.0.0/server');
