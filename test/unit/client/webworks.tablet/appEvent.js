...
describe("webworks_appEvent", function () {
    var appEvent = require('ripple/client/platform/webworks.tablet/2.0.0/server/appEvent'),
        client = require('ripple/client/platform/webworks.tablet/2.0.0/client/appEvent'),
