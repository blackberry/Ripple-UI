...
describe("geo", function () {
    ...
    it("getPositionInfo returns valid values", function () {
    ...
    it("getPositionInfo's internal position info object is immutable", function () {
        var positionInfo = geo.getPositionInfo(),
    ...
    it("updatePositionInfo updates successfully", function () {
        var positionInfo = {
            latitude: 11,
            longitude: 21,
            altitude: 31,
